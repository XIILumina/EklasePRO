    ...
    <div class="container mt-5">
        ...
        <form action="/grades/store" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="grade_value" id="grade_value" class="form-control" step="0.01" min="0" max="100" required>
            </div>
            <div class="mb-3">
                <label for="grade_date" class="form-label">Date</label>
                <input type="date" name="grade_date" id="grade_date" class="form-control" required>
            </div>
            <div class="mb-3">
